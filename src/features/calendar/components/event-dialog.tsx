...
export function EventDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='grid w-[calc(100%-1.5rem)] max-w-210 max-h-[calc(100dvh-1rem)] min-h-0 grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden rounded-[var(--radius-xl)] border-border/70 bg-popover p-0 shadow-lg sm:w-[calc(100%-2rem)] sm:max-h-[calc(100dvh-3rem)]'>
