...
export function Messenger() {
  ...
  return (
    <div className='relative grid h-[calc(100dvh-5.5rem)] w-full grid-rows-[auto,1fr] gap-3 overflow-hidden rounded-[var(--radius-xl)] border border-border/70 bg-background p-3 sm:gap-4 sm:p-4 lg:[grid-template-columns:30%_1fr] lg:grid-rows-[1fr] lg:gap-4 lg:p-5'>
      <ConversationSelect
