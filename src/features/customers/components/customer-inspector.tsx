                ...
                <div className='mt-4 flex flex-wrap items-center gap-2'>
                  <div className='flex items-center rounded-[13px] border border-border/55 bg-background p-0.5 shadow-[0_1px_1px_rgba(23,32,25,0.02)]'>
                    ...
                    <AddNoteDialog
                      ...
                      triggerClassName='h-8 rounded-[10px] border-transparent px-2.5 text-xs font-medium shadow-none transition-[background-color,transform] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:border-transparent hover:bg-muted/65 active:scale-[0.98] sm:px-3'
