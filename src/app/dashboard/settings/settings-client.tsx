        ...
        <Card>
          <CardHeader>
            <div className='flex items-center justify-between gap-3'>
              ...
              <Badge variant='secondary'>{plan === 'team' ? 'Equipo' : 'Autónomo'}</Badge>
            </div>
          </CardHeader>
          <CardContent className='space-y-4'>
            <div className='grid gap-4 md:grid-cols-2'>
              <div className='rounded-2xl border border-border/60 bg-muted/30 p-3'>
                ...
                <p className='mt-2 text-sm font-medium'>Propietario</p>
              </div>
              <div className='rounded-2xl border border-border/60 bg-muted/30 p-3'>
                <p className='text-muted-foreground text-xs uppercase tracking-[0.2em]'>Zona</p>
                <p className='mt-2 text-sm font-medium'>
                  {memberCount}/{seatLimit} miembros
                </p>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            <div className='flex items-center justify-between rounded-2xl border border-border/60 bg-background/60 p-3'>
              ...
              <strong className='text-sm'>{memberCount}</strong>
            </div>
            <div className='flex items-center justify-between rounded-2xl border border-border/60 bg-background/60 p-3'>
