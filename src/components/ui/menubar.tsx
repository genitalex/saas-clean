...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        'min-w-36 rounded-xl border border-border/70 bg-popover/98 p-1 text-popover-foreground shadow-[0_12px_28px_-20px_rgba(15,23,42,0.35)] ring-1 ring-foreground/5 duration-150 ease-[cubic-bezier(0.32,0.72,0,1)] data-[side=bottom]:slide-in-from-top-1 data-[side=inline-end]:slide-in-from-left-1 data-[side=inline-start]:slide-in-from-right-1 data-[side=left]:slide-in-from-right-1 data-[side=right]:slide-in-from-left-1 data-[side=top]:slide-in-from-bottom-1 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95',
        className
      )}
      {...props}
    />
