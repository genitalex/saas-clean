      ...
      <header className='relative flex h-14 shrink-0 items-center justify-between gap-3 px-3 sm:px-5'>
        ...
        <div className='flex min-w-0 flex-1 items-center justify-end gap-1.5 sm:gap-2'>
          <button
            ...
            className='text-muted-foreground hover:bg-muted hover:text-foreground inline-flex h-10 min-w-0 flex-1 items-center justify-start gap-1.5 rounded-[11px] border border-border/70 bg-background px-3 text-xs font-medium shadow-[0_1px_2px_rgba(15,23,42,0.03)] transition-colors md:hidden'
          >
