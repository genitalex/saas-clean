...
function SortableWidget({
  ...
  return (
    <section
      ...
      style={style}
      className={cn(
        'relative mb-3 flex min-w-0 flex-col overflow-visible rounded-xl bg-muted/20 ring-1 ring-border/60 transition-[box-shadow,ring-color,background-color,opacity] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] md:mb-4',
        editing && 'touch-none',
