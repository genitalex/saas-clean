...
function SortableWidget({
  ...
  return (
    <section
      ...
      style={style}
      className={cn(
        'relative mb-3 flex min-w-0 flex-col overflow-visible rounded-xl bg-background/65 backdrop-blur-sm ring-1 ring-border/55 shadow-[0_6px_20px_rgba(31,57,45,0.035)] transition-[box-shadow,ring-color,background-color,opacity] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] md:mb-4',
        editing && 'touch-none',
