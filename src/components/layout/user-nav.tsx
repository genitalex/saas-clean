  ...
  return (
    <div ref={rootRef} className='relative'>
      ...
      <button
        ...
        className='inline-flex h-10 items-center gap-2 rounded-[12px] border border-transparent bg-transparent px-1.5 pr-2.5 shadow-none transition-colors hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring'
      >
