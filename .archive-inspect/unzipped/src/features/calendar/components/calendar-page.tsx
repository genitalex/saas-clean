    ...
    <div className='flex flex-col gap-4'>
      ...
      {isError && (
        <p className='text-destructive rounded-md border border-destructive/30 bg-destructive/5 px-3 py-2 text-sm'>
          No se pudieron cargar los eventos. Puedes reintentar cambiando de periodo.
        </p>
      )}
      <Card className='overflow-hidden'>
        ...
        {view === 'week' && (
          <WeekView cursor={cursor} events={events} onOpenEvent={openEvent} onCreate={openCreate} />
        )}
        {view === 'day' && (
          <DayView cursor={cursor} events={events} onOpenEvent={openEvent} onCreate={openCreate} />
        )}
      </Card>
      <EventDialog
        open={dialogOpen}
